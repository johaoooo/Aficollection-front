...
const evenements = [
  ...
  {
    id: 4,
    image: 'https://res.cloudinary.com/dq4ozytoq/image/upload/q_auto/f_auto/v1777838904/WhatsApp_Image_2026-05-03_at_13.13.39_rnltyi.jpg',
...
// Le reste du fichier (statutConfig, filtres, composant Evenements) reste identique
const statutConfig = {
                    ...
                    >
                      <div className="relative h-40 overflow-hidden">
                        <img
                          src={evt.image}
                          alt={evt.titre}
                          className={`w-full h-full object-cover transition-transform duration-500 hover:scale-105 ${isGrise ? '' : ''}`}
                        />
