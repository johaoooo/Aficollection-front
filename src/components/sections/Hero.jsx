...
const slides = [
  {
    image: 'https://res.cloudinary.com/dq4ozytoq/image/upload/q_auto/f_auto/v1777838903/WhatsApp_Image_2026-05-03_at_13.08.20_lfgl8x.jpg',
  ...
  {
    image: 'https://res.cloudinary.com/dq4ozytoq/image/upload/q_auto/f_auto/v1777838902/WhatsApp_Image_2026-05-03_at_13.07.43_u3dko8.jpg',
      ...
      <div className="relative w-full max-w-7xl mx-auto rounded-3xl overflow-hidden shadow-2xl">
        ...
        <AnimatePresence mode="sync">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-black/40 via-black/30 to-black/40 dark:from-black/50 dark:via-black/40 dark:to-black/50" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-black/20 to-black/30 dark:from-black/60 dark:via-black/30 dark:to-black/40" />
            <div className="absolute inset-0 bg-gradient-to-r from-black/30 via-transparent to-black/20 dark:from-black/40 dark:via-transparent dark:to-black/30" />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 py-8 md:py-10 min-h-[550px]">
          ...
          <AnimatePresence mode="wait">
            <motion.h1
              ...
              className="font-display font-black leading-[1.2] mb-3 max-w-3xl text-white bg-black/20 backdrop-blur-sm px-4 py-2 rounded-2xl inline-block"
              style={{ fontSize: 'clamp(2rem, 6vw, 3.8rem)', textShadow: '0 4px 15px rgba(0,0,0,0.5), 1px 1px 2px rgba(0,0,0,0.3)' }}
            >
          ...
          <AnimatePresence mode="wait">
            <motion.p
              ...
              style={{ textShadow: '0 2px 8px rgba(0,0,0,0.5), 1px 1px 2px rgba(0,0,0,0.2)' }}
            >
              {slide.subtitle}
            </motion.p>
          </AnimatePresence>
